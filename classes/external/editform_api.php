...
/**
 * Provides {@link block_voice\external\editform_api} trait.
 *
 * @package   block_voice
 * @category  external
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class editform_api extends external_api {
     ...
     */
    public static function editform_api_parameters() {
     ...
     */
    public static function editform_api($action, $data) {
        ...
        // Validate params.
        self::validate_parameters(self::editform_api_parameters(), compact('action', 'data'));
     ...
     */
    public static function editform_api_returns() {
